...
export function MSALInterceptorConfigFactory(): MsalInterceptorConfiguration {
  ...
  protectedResourceMap.set('http://localhost:3000/api', ['api://9cd4887c-adfb-4966-8324-9629841da63c/access_as_user']);
  return {
...
export function MSALGuardConfigFactory(): MsalGuardConfiguration {
  return { 
    ...
    authRequest: {
      ...
      // 'api://9cd4887c-adfb-4966-8324-9629841da63c/General',
      'api://9cd4887c-adfb-4966-8324-9629841da63c/access_as_user',
    'access_as_user']
    },
